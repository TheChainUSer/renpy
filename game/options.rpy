...
define config.name = _("National Park Girls")
...
define build.name = "NationalParkGirls"

define config.main_menu_music = "music/NPG_Insert_F_Instrumental.mp3"
...
define config.save_directory = "NationalParkGirls-1531944291"
...
init python:
    ...
    config.emphasize_audio_time = 15.0
    config.emphasize_audio_volume = 0.4
    config.default_emphasize_audio = True
    config.default_music_volume = 0.5

## But moooooooooom I don't wanna take my ambien
init python:
